...
public class productReConfiguration extends Base {

	public productReConfiguration(WebDriver driver) {
		this.driver = driver;
	...
	public WebDriver productReConfiguration(String sellinglane, String productname, String freeperiod, Date Termstartdate,
		...
		// Thread.sleep(30000);
		int x = driver.findElements(By.xpath("//paper-checkbox[@id='checkbox']")).size();
		//System.out.println(x);
		for (int i = 1; i <= x; i++) {
			WebElement p = driver.findElement(By.xpath("(//paper-checkbox[@id='checkbox'])[" + i + "]"));
			String check = p.getAttribute("aria-checked");
			String dis = p.getAttribute("aria-disabled");
			if (dis.equals("false")) {
