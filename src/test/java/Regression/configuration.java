...
public class configuration extends Base {
	...
	public WebDriver proconfiguration(String sellinglane, String productname, String freeperiod, Date Termstartdate,
			int Subscriptionterm, Date startdate, double discount, String discountoption, String subproducts,
	    ...
	    System.out.println(startdate);
				...
				Date date1 = Termstartdate;  
				DateFormat dateFormat1 = new SimpleDateFormat("M/dd/yyyy"); 
			    String TermstartDate = dateFormat1.format(date1);
				...
				if (!freeperiod.isEmpty()) {
					...
					if (freeperiod.contains("1")) {
						...
						expenddate = enddate(String.valueOf(Subscriptionterm), startdate1);
				...
				if (!Discount.isEmpty()) {
					ql.gettoggle().click();
					Thread.sleep(5000);
					int y = driver.findElements(By.xpath("//*[@class='row style-scope sf-le-table-row']")).size();
					//System.out.println(y);
					for (int i = 2; i <= y + 1; i++) {
						WebElement NP = driver.findElement(By.xpath("(//*[@field='SBQQ__NetPrice__c'])[" + i + "]/div"));
						price = priceval(NP);
						...
						if (price > 0) {
							...
							Thread.sleep(1000);
							js.executeScript("arguments[0].click();",
									driver.findElement(By.xpath("//*[text()='Quote Information']")));
							quoteline = driver.findElement(By.xpath("(((//*[@field='SBQQ__AdditionalDiscount__c'])[" + i
									+ "])//preceding-sibling::div[@field='SBQQ__ProductName__c'])//span[2]")).getText();
							ql.gettoggle().click();
							break;
						}
				...
				if (!Discount.isEmpty()) {
					...
					if (!Discount.isEmpty()) {
						...
						System.out.println(disc + "," + amt + "," + Total + "," + Actual);
